...
export default function DashboardChatNativePage() {
...
╚══════╝╚═╝  ╚═╝   ╚═╝   ╚═╝`}</pre>
          ...
          {runs.length ? (
            <section className="dashboard-chat__workbench">
            ...
            <section className="dashboard-chat__workbench">
              ...
              <div className="dashboard-run-detail">
                ...
                {selectedArtifacts.length ? (
                  <div className="dashboard-run-detail__artifacts">
                    {selectedArtifacts.map((artifact) => (
                      <button
                        key={artifact.id}
                        type="button"
                        className="dashboard-run-detail__artifact"
          ...
          {(selectedArtifacts.length || artifacts.length) ? (
            <section className="dashboard-chat__workbench">
              ...
              <div className="dashboard-chat__artifacts">
                {(selectedArtifacts.length ? selectedArtifacts : artifacts).map((artifact) => (
                  <article key={artifact.id} className="dashboard-artifact-card">
                    ...
                    <div className="dashboard-artifact-card__copy">
                      ...
                      {artifact.storage?.provider === "s3" ? (
                        <span className="dashboard-artifact-card__storage">Stored in S3</span>
                      ) : (
                        <span className="dashboard-artifact-card__storage">Stored in workspace</span>
                      )}
                    </div>
